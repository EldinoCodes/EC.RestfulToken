...
INSERT  INTO [dbo].[Tenant] ([TenantId], [CreatedDate], [CreatedBy], [ModifiedDate], [ModifiedBy], [Name])
VALUES                     ('90E70F3A-4A0F-F011-89C2-80B655E9AB1F', GETUTCDATE(), 'SYSTEM', GETUTCDATE(), 'SYSTEM', 'TestTenant');
GO

INSERT  INTO [dbo].[User] ([UserId], [TenantId], [CreatedDate], [CreatedBy], [ModifiedDate], [ModifiedBy], [UserName], [Email])
...
INSERT  INTO [dbo].[UserSecret] ([TenantId], [CreatedDate], [CreatedBy], [ModifiedDate], [ModifiedBy], [UserId], [Secret])
